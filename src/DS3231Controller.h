...
public:
    ...
    [[nodiscard]] uint32_t getSecondsUntilNextEvent() const noexcept;

    // Vacation mode
    void setVacationMode(bool enabled, const DateTime& start = DateTime(), const DateTime& end = DateTime());
    [[nodiscard]] bool isVacationMode() const noexcept;
    ...
    [[nodiscard]] bool isTemperatureCompensationEnabled() const noexcept;
    ...
    [[nodiscard]] bool isBatteryBackupEnabled() const noexcept;
    [[nodiscard]] float getBatteryVoltage() const noexcept;
    ...
    [[nodiscard]] size_t getScheduleDataSize() const noexcept;
